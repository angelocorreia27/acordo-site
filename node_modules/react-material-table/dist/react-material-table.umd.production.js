(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@emotion/styled'), require('react'), require('@emotion/core'), require('tslib')) :
  typeof define === 'function' && define.amd ? define(['@emotion/styled', 'react', '@emotion/core', 'tslib'], factory) :
  (global = global || self, global['react-material-table'] = factory(global.styled, global.React, global.core, global.tslib_1));
}(this, function (styled, React, core, tslib_1) { 'use strict';
  ...
  var ReactMaterialTable = function ReactMaterialTable(props) {
    var _React$useState = React.useState(props.defaultSort),
    ...
    var _React$useState3 = React.useState(bools),
    ...
    var tableBody = function tableBody() {
      if (props.loading) {
        return React.createElement(CenteredDiv, null, React.createElement(LoadingSpinner, null));
      }

      if (props.data.length === 0) {
        return React.createElement(CenteredDiv, null, props.noData || "No Data");
    ...
    return React.createElement(MainDiv, {
      className: props.className
    }, buildTitleRow(props.header, props.headerCustomContent), React.createElement(TableDiv, {
      className: "table-div"
    }, React.createElement(TableHeaderRowDiv, {
  ...
  var buildTitleRow = function buildTitleRow(header, headerCustomContent) {
    return React.createElement(TableTitleRow, {
      className: "table-title-row"
    }, React.createElement(TableTitleDiv, {
  ...
  var renderRow = function renderRow(columns, onRowSelection, accordion, toggleAccordion, openIndexes, defaultMinColWidth) {
    return function (rowItem, index) {
      ...
      return React.createElement("div", {
        key: index
      }, React.createElement(TableRowDiv, {
        className: "table-row",
  ...
  var renderRowColumn = function renderRowColumn(rowItem, totalWidthProportions, index, openIndexes, toggleAccordion, defaultMinColWidth) {
    return function (columnItem, columnIndex) {
      ...
      return React.createElement(TableRowItemDiv, {
        key: columnIndex,
  ...
  var renderHeaderColumn = function renderHeaderColumn(totalWidthProportions, setSortedColumn, sortedColumn, sortCallback, defaultMinColWidth) {
    return function (item, index) {
      ...
      return React.createElement(TableHeaderItemDiv, {
        key: index,
        totalWidthProportions: totalWidthProportions,
  ...
  var renderArrow = function renderArrow(sortable, isCurrentColumn, order) {
    if (isCurrentColumn) {
      return React.createElement(ArrowIcon, {
        order: order,
        height: "20px"
      });
    }
    ...
    if (sortable) {
      return React.createElement(HoverableArrow, {
        height: "20px",
        id: "hoverableArrow"
      });
    }
